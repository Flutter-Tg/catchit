...
import 'package:catchit/core/utils/global_widgets/ads/reward_ad.dart';
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            launchUrl(
                                Uri(scheme: 'mailto', path: 'hi@catchit.live'));
                          },
                          child: Text(
                            'Contact us',
                            style: TextStyle(
